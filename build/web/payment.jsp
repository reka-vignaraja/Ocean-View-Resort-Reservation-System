    ...
    if(reservationIdStr != null){
        try {
            ...
            try(Connection con = DriverManager.getConnection(
                ...
                String sql = "SELECT guest_name, room_type FROM reservations WHERE reservation_id=?";
            ...
            out.println("<p style='color:red;'>Invalid reservation ID.</p>");
...
<head>
    ...
    <style>
        ...
        .container { background: white; padding: 30px; border-radius: 15px; width: 400px; box-shadow: 0 10px 25px rgba(0,0,0,0.2); }
        h2 { text-align: center; margin-bottom: 25px; color: #2c5364; }
        input, select { width: 100%; padding: 10px; margin: 8px 0; border-radius: 8px; border: 1px solid #ccc; font-size: 14px; }
        input:focus, select:focus { border-color: #2c5364; box-shadow: 0 0 5px #2c5364; }
        button { width: 100%; padding: 12px; margin-top: 15px; border: none; border-radius: 25px; background-color: #2c5364; color: white; font-size: 16px; cursor: pointer; transition: 0.3s; }
